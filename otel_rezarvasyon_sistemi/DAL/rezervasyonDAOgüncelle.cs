...
{
    internal class rezervasyonDAOgüncelle
    {
        public void rezervasyonkaydet(Rezervasyon grezervasyon)
        {
            try
            {
               ...
               "SET TC = @TC, TELEFON = @Telefon, ADSOYAD = @AdSoyad, EPOSTA = @Eposta, ODATİPİ = @OdaTipi, ODALAR = @Odalar,GİRİŞTARİHİ=@giristarihi ,ÇIKIŞTARİHİ=@cıkıştarihi" +
                " WHERE TC = @TC";
