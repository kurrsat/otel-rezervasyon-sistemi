...
using otel_rezarvasyon_sistemi.DOMAİN;
using System;
...
{
    internal class rezervasyonSERVİCESsil
    {
        public void RezervasyonKaydet(string gTC, string gTELNO, string gADSOYAD, string gEposta, string gOdaTipi, string gOdalar, string gGiristarihi, string Çıkıştarihi)
        {
            ...
            (new rezervasyonDAOsil()).rezervasyonkaydet(new Rezervasyon(gTC, gTELNO, gADSOYAD, gEposta, gOdaTipi, Convert.ToInt32(gOdalar), gGiristarihi, Çıkıştarihi));
